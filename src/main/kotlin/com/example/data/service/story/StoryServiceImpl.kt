...
import com.example.data.db.Schemas.LikeTable.innerJoin
import com.example.data.db.Schemas.StoryTable
import com.example.data.db.Schemas.StoryTable.content
import com.example.data.db.Schemas.StoryTable.innerJoin
...
import com.example.data.db.extension.toStory
...
//        val storyRow = DatabaseFactory.dbQuery { StoryTable.select { StoryTable.id eq id } }
...
//        val stories = DatabaseFactory.dbQuery {
//            StoryTable
//                .innerJoin(UserTable, { UserTable.id }, { userId })
...
//            LikeTable.innerJoin(storyTable, { storyId }, { storyTable[StoryTable.id] })
...
//        var result = -1
//        DatabaseFactory.dbQuery {
//            result = StoryTable.deleteWhere { id eq storyId }
//        }
//        return result == 1
//    }
//
